import 'components_list.dart' show Color, Colors;

class AppColors {
  static const Color primaryColor = Color(0xffFD7A06);
  static const Color primaryColorVariant = Color(0xffF2EDD0);
  static const Color textColorSecond = Colors.white;

  static const Color secondaryColor = Color(0xFF932879);
  static const Color backgroundColor = Color(0xFFEEEEEE);
  static const Color primaryText = Color(0xFF000000);
  static const Color buttonColor = Color(0xff0054A5);

  static const Color textColor = AppColors.blackShade4;
  static const Color textColor2 = Color(0xff69BD6D);
  static const Color chatBg = Color(0xffDAFFD4);
  static const Color textBg = Color(0xff43AC34);
  ...
  static const Color pink = Color(0xFFe5007e);
  static const Color pinkShade1 = Color(0xFFF8E8EE);
  static const Color pinkShade4 = Color(0xFFEF4F93);
  static const Color pinkShade5 = Color(0xFFF396B6);
