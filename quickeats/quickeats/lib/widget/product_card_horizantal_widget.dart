...
class ProductCardHorizontalWidget extends StatelessWidget {
  const ProductCardHorizontalWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
          ...
          ? const SizedBox()
          : SizedBox(
        height: SizeConfig.blockSizeVertical = 310,
...
class SearchResultHere extends StatelessWidget {
  const SearchResultHere({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.put(HomeController());
    return  Obx(()=>controller.isSearch.isTrue ? const SizedBox():const TextLine(title: "Search results", fontSize: 20));
  }
}
